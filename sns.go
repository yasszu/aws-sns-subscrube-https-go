...
var (
	...
	ErrInvalidCertURL          = errors.New("error validate cert url: invalid url")
	ErrInvalidCertURLSchema    = errors.New("error validate cert url: invalid scheme")
	ErrInvalidCertURLHost      = errors.New("error validate cert url: invalid host")
