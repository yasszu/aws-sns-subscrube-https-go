	...
	tests := map[string]struct {
		...
		"success": {
			message: SubscriptionConfirmation{
				...
				Token:            "2ba91ca0",
				TopicArn:         "arn:aws:sns:ap-northeast-1:000000000000:topic",
				Message:          "You have chosen to subscribe to the topic arn:aws:sns:ap-northeast-1:000000000000:topic.\nTo confirm the subscription, visit the SubscribeURL included in this message.",
			...
			want: MessageSignature{
				Signed: []byte(strings.Join([]string{
					"Message",
					"You have chosen to subscribe to the topic arn:aws:sns:ap-northeast-1:000000000000:topic.\nTo confirm the subscription, visit the SubscribeURL included in this message.",
					"MessageId",
					...
					"2ba91ca0",
					"TopicArn",
					"arn:aws:sns:ap-northeast-1:000000000000:topic",
					"Type",
